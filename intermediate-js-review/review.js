...
// CODE HERE...
function promiseResolver (val) {
  val.then((resolve) => {
    return theAnswer = resolve
  })
}
...
//used to when creating a new function
...
/////named property
const Unicorn = function (hornColor, magicType, mana, canFly) {
...
function countdownMaker (str, days) {
  return function () {
    days -= 1
    return {event: str, daysLeft: days}
  }
}
